    ...
    >
      <div className="lg:max-h-[960px] lg:w-[1440px] mx-auto">
        ...
        <div
          ...
          lg:grid lg:grid-rows-[clamp(2rem,18vh,171px),_auto]s lg:gap-x-10 lg:grid-cols-[minmax(400px,_453px),_minmax(400px,_564px)] lg:justify-between max-w-[1440px] lg:grid-rows-[clamp(2rem,24vh,250px),_auto]"
        >
