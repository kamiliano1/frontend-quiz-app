...
const SingleRadio: React.FC<SingleRadioProps> = ({
  ...
  return (
    <div
      ...
      className={`flex items-center rounded-xl sm:rounded-[1.5rem] shadow-[0px_16px_40px_0px_rgba(143,_160,_193,_0.14)] text-darkNavy p-3 lg:py-[18px] lg:px-5 border-[3px] data-[state=checked]:bg-purple 
        ${
